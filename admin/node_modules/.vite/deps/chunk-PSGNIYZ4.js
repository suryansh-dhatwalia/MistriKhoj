...
var TextareaAutosize = React4.forwardRef(function TextareaAutosize2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime.jsxs)(React4.Fragment, {
...
function useFormControlState({
  ...
  const muiFormControl = React6.useContext(FormControlContext_default);
  const result = {};
...
var formControlLabelClasses = generateUtilityClasses("MuiFormControlLabel", ["root", "labelPlacementStart", "labelPlacementEnd", "labelPlacementTop", "labelPlacementBottom", "disabled", "label", "error", "required", "asterisk"]);
...
function InitColorSchemeScript2(props) {
  ...
  return (0, import_jsx_runtime4.jsx)(InitColorSchemeScript, {
    defaultMode,
...
true ? InitColorSchemeScript2.propTypes = {
   ...
   */
  colorSchemeNode: import_prop_types5.default.string,
  /**
   ...
   * @default 'dark'
   */
  defaultDarkColorScheme: import_prop_types5.default.string,
  /**
   * The default color scheme to be used in light mode.
   * @default 'light'
   */
  defaultLightColorScheme: import_prop_types5.default.string,
  /**
   * The default mode when the storage is empty (user's first visit).
   * @default 'system'
   */
  defaultMode: import_prop_types5.default.oneOf(["dark", "light", "system"]),
  /**
...
function Experimental_CssVarsProvider(props) {
  ...
  return (0, import_jsx_runtime5.jsx)(InternalCssVarsProvider, {
    ...props
  });
}
...
function ThemeProvider({
  ...
  const noVarsTheme = React9.useMemo(() => {
  ...
  if (noVarsTheme) {
    return (0, import_jsx_runtime6.jsx)(ThemeProviderNoVars, {
      theme: noVarsTheme,
      ...props
    });
  }
  return (0, import_jsx_runtime6.jsx)(CssVarsProvider, {
    theme,
    ...props
  });
}
...
//# sourceMappingURL=chunk-PSGNIYZ4.js.map
